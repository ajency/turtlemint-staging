<?php
/**
  Template Name: AgentLoc Test Page2
 */
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="mainscreen">
        ...
        <script>
            $(document).ready(function () {
                $("#findAdvisor").on('click touchend', function(e) { findAdvisor(); });

                // FETCHING DATA FROM JSON FILE
                $.getJSON("/wp-content/themes/turtlemint/gfgdetails.json", 
                        function (data) {
                    var student = '';
                    var foundit = false;
                    ...
                    $.each(data, function (key, value) {
                        if(value.NoOfProblems==getParameterByName('pincode')){
                            foundit = true;
