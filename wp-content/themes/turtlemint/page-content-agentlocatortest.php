<?php
/**
  Template Name: Test Agent Locator
 */
?>
<!DOCTYPE html>
<html lang="en">
	<head>
		...
		<script>
            function findAdvisor(){
                ...
                window.location.href = "/agent-locator-page-2?pincode="+pincode;
            }
	...
	<body>
        <div class="mainscreen">
            <!-- TABLE CONSTRUCTION-->
            <form name="advisor-locator" id="advisor-locator" action="">
                <label for="fname">First name:</label><br>
                <input type="text" id="pincode" name="pincode"><br>
                <input type="checkbox" id="selfAge" name="selfAge" value="60"><br>
                <label for="lname">Last name:</label><br>
                <input type="text" id="lname" name="lname">
                <input id="findAdvisor" type="submit" value="CALCULATE TAX SAVINGS" class="btn-green find-Advisor-cta">
            </form>
        ...
        <script>
			...
			$("#submitTax").on('click touchend', function(e) { taxSaverCalc(); });
        </script>
        <script>
