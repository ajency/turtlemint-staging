<?php
/**
	 Template Name: Content A Revamp
	*/
...
<div class="container">
	<div class="row ">
		<div class="col-md-12 d-xl-none d-md-none d-sm-block gray-background bgcolor" style="min-height: 0px;"> 
			<img style="margin: 0 auto; display: block;" src="<?php bloginfo('stylesheet_directory'); ?>/tm-assets/img/car-banner-mobile.webp" class="banner-mobile" alt=""/>
		</div>
	</div>
</div>
<div class="container1">
	<div class="row">
		<div class="col-md-12 d-xl-none d-lg-none d-sm-none d-md-block gray-background bgcolor"> 
			<img style="margin: 0 auto; display: block;" src="<?php bloginfo('stylesheet_directory'); ?>/tm-assets/img/car-banner-tab.png" class="banner-tab" alt=""/>
		</div>
	</div>
</div>
<!-- ======= Navbar End ======= -->
		...
		<div class="row">
			<div class="col-md-12 col-lg-12 col-xl-10">
				<div class="main-banner-txt">
					<h1 class="d-none d-lg-block">Save Upto <span style="color:#007D65;">70%</span> on Car Insurance</h1>
					<div class="row banner-crd">
						<div class="col-lg-1 d-none"></div>
						<div class="col-md-5 col-xl-5 col-lg-4 col-lg-offset-1 col-xs-8 col-md-7 search-plans">
							<input class="search-input" oninput="this.value = this.value.toUpperCase();" type="text" value="" name="regno" maxlength="14" placeholder="Car number (MH01AB1234)">
						</div>
						<div class="search-btn-wrapper col-xl-4 col-lg-2 col-xs-4 col-sm-4 col-md-3">
							<button class="search-btn" id="with-regno"><!--<img class="search-img" src="<?php bloginfo('stylesheet_directory'); ?>/tm-assets/img/search.png">-->Get quotes</button>
						</div>
					</div>
					<div class="errtext" id="errMsg"></div>
					<div class="row continue-nonumber-wrapper">
						<h5><a class="getquote-text" href="#" id="without-reg-link">Get Quotes Without Car Number <img src="<?php bloginfo('stylesheet_directory'); ?>/tm-assets/img/chevron-right.png" style="margin-left: 8px"></a></h5>
					</div>
					<h4 class="getquote-text2">Need help in choosing the right policy?</h4>
					<div class="col-lg-5 col-md-6 banner-cta new">
						...
						<div class="banner-cta-text">
							<h5 class="thrive-car-form cf7-car-form"><a href="#!">Contact a Turtlemint Advisor</a><img src="<?php bloginfo('stylesheet_directory'); ?>/tm-assets/img/chevron-right.png"></h5>
						</div>
					</div>
				</div>
			</div>
