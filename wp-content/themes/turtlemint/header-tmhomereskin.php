...
<html <?php language_attributes(); ?>>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php bloginfo('stylesheet_directory'); ?>/tm-assets/css/style-reskin.css" />
		<link rel="stylesheet" type="text/css" href="<?php bloginfo('stylesheet_directory'); ?>/tm-assets/css/stylemedia-reskin.css" />
		<link rel="stylesheet" type="text/css" href="<?php bloginfo('stylesheet_directory'); ?>/tm-assets/css/responsive-reskin.css" />
	...
	<div class="canvas-container mobile-nav">
		<div class="content-container">
			<div class="inner-container">
                <a class="mobile-logo" href="/"><img src="<?php bloginfo('stylesheet_directory'); ?>/tm-assets/img/logo.png" alt="Turtlemint" style="/*width: 180px;margin: 0 auto; padding:15px 15px 0px 5px;*/     width: 39%; margin: 0 auto; padding: 24px 0px 0px 0px; margin-left: 6px;"></a>
