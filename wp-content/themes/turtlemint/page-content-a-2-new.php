<?php
	/**
	  Template Name: Content A 2 New
	 */
	
	get_header('product');
	?>
		<!-- ======= Navbar End ======= -->
		<style>.bike-offer .item-box {
		text-align: center;
		background: white;
		padding: 40px 19px;
		margin: 10px;
        ...
        .bike-banner{
            background: url(<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/bike-banner.png), #F8F4F3;
		...
		<h1>Save Upto <span style="color:#007D65;">40%</span> on Bike Insurance</h1>
		<div class="row banner-crd">
		<div class="col-lg-1 d-none"></div>
		<div class="col-md-5 col-xl-5 col-lg-8 col-lg-offset-1 col-xs-8 search-plans">
		<input class="search-input" oninput="this.value = this.value.toUpperCase();" type="text" value="" name="regno" maxlength="14" placeholder="Bike number (MH01AB1234)">
		</div>
		<div class="search-btn-wrapper col-xl-4 col-lg-2 col-xs-4 col-md-4">
		<button class="search-btn" id="with-regno"><img class="search-img" src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/search.png">Find Plans</button>
		</div>
		</div>
		<div class="row continue-nonumber-wrapper">
		<h5><a href="#" id="without-reg-link">Continue Without Bike Number</a></h5>
		</div>
		<h4>Need help in choosing the right policy?</h4>
		...
		<h5 class="thrive-bike-form cf7-bike-form"><a href="#!">Contact a Turtlemint Advisor</a><img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/chevron-right.png"></h5>
		</div>                               
		</div>
		</div>
		</div>
		...
		<h5>Check your Bike Insurance knowledge!</h5>
		<a href="#" class="play-quiz-btn">Find Out Now</a>
		</div>
		</div>
		</div>
		</div>
		...
		<h2>Before you make a decision<br>Get a detailed understanding of Bike Insurance.</h2>
		...
		<div class="custom-video-crd video-bike-1"  role="button" data-toggle="modal" data-target="#Homevid1-video-modal-disabled">
		...
		<div class="custom-video-crd video-bike-2" role="button" data-toggle="modal" data-target="#Homevid2-video-modal-disabled">
		...
		<div class="carousel-item">
		<div class="custom-video-crd video-bike-3" role="button" data-toggle="modal" data-target="#Homevid3-video-modal-disabled">
		<a href="#!"><img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/life-blog-video-1.png" width="100%" height="auto" frameborder="0" /></a>
		<h5>Upskilling The Aspiring Micro-Entrepreneurs In India</h5>
		<p>I'm baby try-hard farm-to-table tofu, taiyaki tacos food trcuk meditation</p>
		</div>
		...
		<div class="col-lg-3 col-md-4 item-box"><a class="hovere" href="https://tm.stagingtech.in/two-wheeler-insurance/third-party-bike-insurance/">
		<img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/car-offer-icon-1.png">
		<h5>Third-Party Liability</h5>
		<p>Covers damages and losses caused to a third-party</p></a>
		</div>
		<div class="col-lg-3 col-md-4 item-box"><a class="hovere" href="https://tm.stagingtech.in/two-wheeler-insurance/comprehensive-bike-insurance/">
		<img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/car-offer-icon-2.png">
		<h5>Comprehensive Bike Cover</h5>
		<p>Covers damages and losses to your Bike as well as to a third party</p></a>
		</div>
		</div>
		<div class="bike-offer mobile-slider d-md-none d-sm-block">
		<div class="item-box"><a class="hovere" href="https://tm.stagingtech.in/two-wheeler-insurance/third-party-bike-insurance/">
		<img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/car-offer-icon-1.png">
		<h5>Third-Party Liability</h5>
		<p>Covers damages and losses caused to a third-party</p></a>
		</div>
		<div class="item-box"><a class="hovere" href="https://tm.stagingtech.in/two-wheeler-insurance/comprehensive-bike-insurance/">
		<img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/car-offer-icon-1.png">
		<h5>Comprehensive Bike Cover</h5>
		...
		<p class="paragraph-text paragraph-style">You can also visit the link <a href="https://tm.stagingtech.in/raise-claim" target="_blank">https://www.turtlemint.com/raise-claim</a> and raise a claim with Turtlemint easily. </p>
		</div>
		</div>
		</div>
		</div>
