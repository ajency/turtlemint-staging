...
?>
	...
	<div class="container">
	 ...
	 <div class="col-md-12 bgcolor" style="min-height: 0px;"> 
				<img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/main-banner-mobile.png" class="banner-mobile" alt=""/>
				</div> </div></div>
	<div class="container1">
		<div class="row">		
	 <div class="col-md-12 bgcolor"> 
				<img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/main-banner-tab.png" class="banner-tab" alt=""/>
				</div> </div></div>
		...
		<div class="row">			
                ...
                <div class="col-lg-10 col-md-12">                    
                    <div class="main-banner-txt">
                        <h2>Be Active With the Right <span>&nbsp;Insurance&nbsp;</span></h2>
				<div class="container">
                        <div class="row banner-crd">
							...
							<a href="https://tm.stagingtech.in/car-insurance" onclick="addUTM(this); return false;">
                                <div class="banner-img">
                                    <img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/car.png">
                                </div>
								</a>
                            </div>
							...
							<a href="https://tm.stagingtech.in/two-wheeler-insurance" onclick="addUTM(this); return false;">
                                <div class="banner-img">
                                    <img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/bike.png">
                                </div>
								</a>
                            </div>
							...
							<a href="https://tm.stagingtech.in/health-insurance">
                                <div class="banner-img">
                                    <img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/health.png">
                                </div>
								</a>
                            </div>
							...
							<a href="https://tm.stagingtech.in/life-insurance">
                                <div class="banner-img banner-img-life">
                                    <img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/life.png">
                                </div>
								</a>
                            </div>
                        </div>
                        ...
                        <h4>Need help in choosing a suitable plan?</h4>
                        <h5 id="thrive-home-form" class="thrive-home-form cf7-home-form"><a href="#!">Let a Turtlemint Advisor Help You</a></h5>
                        <p>“We have more than 15 lakh advisors <br class="d-block d-sm-none">across 15000 pin codes in India"</p>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="custom-advisor">
                        <div class="adv-img">
                            <img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/grp01.png">
                        </div>
                        <div class="adv-content">
                            <h5><a href="https://www.mintpro.in/"  target="_blank">Become a Turtlemint Advisor</a></h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <!-- Video slider visible only on mobile -->
                    ...
                    <div class="slider slider-nav">
                        <div class="col-md-12">
                            <div class="custom-video-crd video-home-1" role="button" data-toggle="modal" data-target="#Homevid1-video-modal-disabled">
                        ...
                        <div class="col-md-12">
                            <div class="custom-video-crd video-home-2" role="button" data-toggle="modal" data-target="#Homevid2-video-modal-disabled">
                ...
                <div class="col-md-3 d-none d-lg-block"><!-- Hidden on xs -->
                    <div class="custom-video-crd video-home-1" role="button" data-toggle="modal" data-target="#Homevid1-video-modal-disabled">
                       <img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/life-blog-video-1.png" width="100%" height="auto" frameborder="0" />
                ...
                <div class="col-md-3 d-none d-lg-block"><!-- Hidden on xs -->
                    <div class="custom-video-crd video-home-2" role="button" data-toggle="modal" data-target="#Homevid2-video-modal-disabled">
                        <img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/life-blog-video-2.png" width="100%" height="auto" frameborder="0" />
                        <h5>Upskilling The Aspiring Micro-Entrepreneurs In India</h5>
                        <p>I'm baby try-hard farm-to-table tofu, taiyaki tacos food trcuk meditation</p>
                    </div>
                </div>
	...
	<div class="row-2 padd-btm"><!-- visible on all devices -->
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-7">
                    <a class="btn-watch-more" href="https://www.youtube.com/c/InsuranceGyan">Watch More Videos</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row-2">
        <div class="container secondary-banner padd-tb-50">
			...
			<h3 class="custom-become-part">Connecting People and Advisors across the length and breadth of the Country.</h3>
            ...
            <div class="row">
                ...
                <div class="col-md-6 d-none d-sm-block">
                    <div class="custom-orgainize">
                        <h3>Organise And Manage All Of Your<br>Family's Insurance Policies<br>At One Place</h3>
                        <h4>Turtlemint mobile app coming soon</h4>
                        <h5  id="thrive-home-form-2"  class="cf7-home-form-2 thrive-home-form-2 tve-leads-two-step-trigger tl-2step-trigger-20209"><a class="btn-notify-me" href="#!">Notify Me</a></h5>
                    </div>
                </div><!---->
    ...
    <div class="row-2 padd-tb-45 third-banner">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="organize-img">
                        <img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/organize-view.png" />
                    </div>
                </div>
                ...
                <div class="col-md-6 d-block d-sm-none">
                    <div class="custom-orgainize">
                        <h3>Organise and manage all of your family's insurance policies in one place</h3>
                        <h4>Turtlemint mobile app coming soon</h4>
                        <a class="btn-notify-me" href="#">Notify Me</a>
                    </div>
                </div>
                <!------>
               ...
               <!---- <div class="col-md-6 col-12">
                ...
                <div class="col-md-6 col-12">
                    <div class="orgainize-content">
					<h4>Turtlemint will be your one-stop shop:</h4>
                        <ul>
                            <li><img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/checkmark.png" class="checkmark"><span>Understand your insurance requirements</span></li>
                            <li><img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/checkmark.png" class="checkmark"><span>Identify the gaps in coverage</span></li>
                            <li><img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/checkmark.png" class="checkmark"><span>Policy recommendations as per your needs</span></li>
                            <li><img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/checkmark.png" class="checkmark"><span>Follow the do's of insurance knowledge to keep yourself updated.</span></li>
							 <li><img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/checkmark.png" class="checkmark"><span>Manage payments, renewals and claims</span></li>
                        </ul>
                    </div>
                </div>
            </div>
				...
				<div class="section-heading">
					...
					<div class="partner-main">
						<div class="slider slider-partnar">
							<div>
								<img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/partnerPNB.png"/ class="partnerimg">
							</div>
							<div>
								<img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/partnerEdelweiss.png"/ class="partnerimg">
							</div>
							<div>
								<img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/partnerStarhealth.png"/ class="partnerimg">
							</div>
							
							<div>
								<img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/partnerHDFCLIFE.png"/ class="partnerimg">
							</div>
							<div>
								<img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/partnerPNB.png"/ class="partnerimg">
							</div>
							<div>
								<img src="<?php bloginfo('stylesheet_directory'); ?>/tmassets/img/partnerTATAAIG.png"/ class="partnerimg">
							</div>
    ...
    <div class="row-2 blog-cta-section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <a href="https://tm.stagingtech.in/blog/" class="btn-visit-blog">Visit Our Blog</a>
                </div>
            </div>
        </div>
    </div>
							...
							<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="false">
                                ...
                                <div class="panel panel-default">
                                 ...
                                 <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="headingNine">
                                        <h4 class="panel-title">
                                            <a class="collapsed" data-toggle="collapse" data-target="#collapseTen" href="#collapseTen" aria-expanded="false" aria-controls="collapseTen">
                                            What is renewal of an insurance policy?
                                            </a>
                                        </h4>
                                    </div>
