...
<html lang="en">
	<head>
		...
		<style>
            ...
            @media (min-width: 320px) and (max-width: 480px) {
                ...
                input[type="number"],input[type="text"] {
                    width: 68% !important;/*55px !important;*/
                    margin-top: 5px;
                }
            ...
            @media only screen and (width: 320px) { 
                ...
                #tax-calculator1 input[type="number"],#tax-calculator1 input[type="text"] {
                    width: 68% !important;/*67px !important;*/
                    margin-top: 5px;
                }
	...
	<body>
				...
				<div class="container" style="padding : 50px 20px;">
					...
					<form onsubmit="taxSaverCalc()">
						...
						<div class="row">
							...
							<a id="whatsapp" class="btn-green share-tax-savings-cta" target="_blank" alt="" title=""  data-action="share/whatsapp/share">SHARE VIA WHATSAPP</a>
		...
		<script>
			...
			var URL = "https://turtlemint.com/share-your-tax-savings?tHSurplus="+getParameterByName('tHSurplus')+"&tHSaving="+getParameterByName('tHSaving')+"&tLESurplus="+getParameterByName('tLESurplus')+"&tLESaving="+getParameterByName('tLESaving')+"&gTSaving="+getParameterByName('gTSaving');
        ...
        <script type="text/javascript">
            const ctas = document.getElementsByClassName("share-tax-savings-cta");
            for (let i = 0; i < ctas.length; i++) {
            ctas[i].addEventListener("click", function () {
                gtag("event", "PPCLeadCTA", {
                event_category: "PPC",
                event_label: "PPCLeadCTA-TaxCalc-Share-Button",
                });
            });
            }
        </script>
