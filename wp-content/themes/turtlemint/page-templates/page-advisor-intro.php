    ...
    <div class="container tm-advisor-stats-section">
        <div class="left-side tm-loading">
            ...
            <div class="banner-image hide-md-down">
                <img onload="imageSkeletons(this)" src="<?php echo get_stylesheet_directory_uri() ?>/tm-assets/img/tm-img/turtlemint-insurance-advisors.png" alt="Turtlemint Insurance Advisors" title="Turtlemint Insurance Advisors">
            </div>
