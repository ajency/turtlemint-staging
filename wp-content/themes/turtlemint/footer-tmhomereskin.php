...
<!-- inject:foot -->
<!-- modal -->
<div class="modal fade" id="video-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="height: 100%; width: 100%">
...
<div class="modal fade" id="Homevid1-video-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="height: 100%; width: 100%">
	<div class="modal-dialog modal-margin">
		<div class="modal-content">
...
<div class="modal fade" id="Homevid2-video-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="height: 100%; width: 100%">
	<div class="modal-dialog modal-margin">
		<div class="modal-content">
...
<div class="modal fade" id="Homevid3-video-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="height: 100%; width: 100%">
	<div class="modal-dialog modal-margin">
		<div class="modal-content">
...
<style>
	...
	#navbarCollapse>ul>li.nav-item.custom-nav-btn2>a:hover {
		color: #009F69;
	}

	a.dropdown-item.see-more {
...
<script>
	...
	*/
	var selected_card = ''; // variable to store the currently selected card
	function changeImage(img) {
		var img_selector = img + '-img';
		...
		// hide the tick mark for the selected image
		if (img === 'health') {
			$('.blank-tick-health').hide();
			...
			if (value == 'popup') {
				...
				if (img_pressed != '') {
					if (img_pressed == 'bike') {
						...
						window.dataLayer.push({
							'event': 'button_click',
							'click_text': 'findadvisorhealth',
							'button_location': 'banner',
						});
					}

					//GA EVENT START
					gtag('event', 'Btn_click-' + img_pressed.charAt(0).toUpperCase() + img_pressed.slice(1) + '-Find Advisor', {
						event_category: 'HP-Buttons',
			...
			if (value == 'redirect') {
				...
				if (img_pressed != '') {
					...
					if (img_pressed == 'bike') {
						...
						window.dataLayer.push({
							'event': 'button_click',
							'click_text': 'getquoteshealth',
							'button_location': 'banner',
						});
					}

					//GA EVENT START
					gtag('event', 'Btn_click-' + img_pressed.charAt(0).toUpperCase() + img_pressed.slice(1) + '-Get a Quote', {
						event_category: 'HP-Buttons',
