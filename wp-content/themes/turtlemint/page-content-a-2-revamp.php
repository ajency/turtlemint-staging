<?php
	/**
	  Template Name: Content A 2 ReVamp
	 */
...
<div class="container">
    <div class="row ">
        <div class="col-md-12 d-xl-none d-md-none d-sm-block gray-background bgcolor" style="min-height: 0px;"> 
            <img style="margin: 0 auto; display: block;" src="<?php bloginfo('stylesheet_directory'); ?>/tm-assets/img/bike-banner-mobile.webp" class="banner-mobile" alt=""/>
        </div>
    </div>
</div>
<div class="container1">
    <div class="row">
        <div class="col-md-12 d-xl-none d-lg-none d-sm-none d-md-block gray-background bgcolor"> 
            <img style="margin: 0 auto; display: block;" src="<?php bloginfo('stylesheet_directory'); ?>/tm-assets/img/bike-banner-tab.png" class="banner-tab" alt=""/>
        </div>
    </div>
</div>
<!-- ======= Navbar End ======= -->
		...
		<div class="row">
			<div class="col-md-12 col-lg-12 col-xl-10">
				<div class="main-banner-txt">
					<h1 class="d-none d-lg-block">Premiums starting at ₹ 887 *</h1>
					<div class="row banner-crd">
						...
						<div class="search-btn-wrapper col-xl-4 col-lg-2 col-xs-4 col-sm-4 col-md-3">
							<button class="search-btn" id="with-regno"><img class="search-img d-none" src="<?php bloginfo('stylesheet_directory'); ?>/tm-assets/img/search.png">Get quotes</button>
						</div>
					</div>
					<div class="errtext" id="errMsg"></div>
					<div class="row continue-nonumber-wrapper">
						<h5><a class="getquote-text"  href="#" id="without-reg-link">Get Quotes Without Bike Number <img src="<?php bloginfo('stylesheet_directory'); ?>/tm-assets/img/chevron-right.png" style="margin-left: 8px"></a></h5>
					</div>
					...
					<div class="col-lg-5 col-md-6 banner-cta new">
						...
						<div class="banner-cta-text">
							<h5 class="thrive-bike-form cf7-bike-form"><a href="#!">Contact a Turtlemint Advisor</a><img src="<?php bloginfo('stylesheet_directory'); ?>/tm-assets/img/chevron-right.png"></h5>
						</div>
					</div>
				</div>
			</div>
