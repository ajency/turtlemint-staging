<?php
/**
  Template Name: Home Page Revamp
 */
...
?>
	...
	<div class="container-fluid">
	 ...
	 <div class="col-md-12 bgcolor" style="min-height: 0px;"> 
				<img src="<?php bloginfo('stylesheet_directory'); ?>/tm-assets/img/main-banner-mobile.webp" class="banner-mobile" alt=""/>
				</div> 
				<div class="col-md-12 bgcolor" style="min-height: 0px;"> 
				<img src="<?php bloginfo('stylesheet_directory'); ?>/tm-assets/img/main-banner-tab.webp" class="banner-tab" alt=""/>
				</div>
				</div></div>
		...
		<div class="row">			
                ...
                <div class="col-md-12 col-lg-12 col-xl-10">                    
                    <div class="main-banner-txt">
                       ...
                       <h2 class="d-none d-lg-block" style="margin-top:50px">Be Active with the Right Insurance</h2>		
                        <div class="row banner-crd">
                <div class="col-lg-2 col-md-3 col-6 mb-3 bannercrd-img">
                  <div class="banner-img">
                   <a href="/car-insurance" onclick="addUTM(this); return false;" id="home-banner-title-1">
					<img src="<?php bloginfo('stylesheet_directory'); ?>/tm-assets/img/car.png"></a>
                  </div>
                </div>
                <div class="col-lg-2 col-md-3 col-6 mb-3 bannercrd-img">
                  <div class="banner-img">
                    <a href="/two-wheeler-insurance" onclick="addUTM(this); return false;" id="home-banner-title-2">
					<img src="<?php bloginfo('stylesheet_directory'); ?>/tm-assets/img/bike.png"></a>
                  </div>
                </div>
                <div class="col-lg-2 col-md-3 col-6 mb-3 bannercrd-img">
                  <div class="banner-img">
                    <a href="/health-insurance" onclick="addUTM(this); return false;" id="home-banner-title-3">
					<img src="<?php bloginfo('stylesheet_directory'); ?>/tm-assets/img/health.png"></a>
                  </div>
                </div>
                <div class="col-lg-2 col-md-3 col-6 mb-3 bannercrd-img">
                  <div class="banner-img banner-img-life">
                    <a href="/life-insurance" onclick="addUTM(this); return false;" id="home-banner-title-4">
					<img src="<?php bloginfo('stylesheet_directory'); ?>/tm-assets/img/life.png"></a>
                  </div>
                </div>
                        ...
                        <div class="col-lg-5 col-md-6 banner-cta new">
                            ...
                            <h5 class="thrive-health-form cf7-home-form"><a href="#!">Contact a Turtlemint Advisor</a><img src="<?php bloginfo('stylesheet_directory'); ?>/tm-assets/img/chevron-right.png"></h5>
                            </div>                               
                        </div>
                ...
                <div class="col-md-12 col-lg-12 col-xl-10"> 
				<a class="homy" href="https://turtlemintpro.onelink.me/vFlk/1aae1fe7" target="_blank"><p class="homy" style="clear: both; font-family: 'Montserrat';" target="_blank"><span style="text-decoration: underline; color: #4fae5e;"></br></br>Join as a PoSP</span> <span style="color: #000;"> Insurance Advisor today </span></p></a></div>
